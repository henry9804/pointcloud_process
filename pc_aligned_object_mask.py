...
from utils import pc2_to_numpy, numpy_to_pc2_rgb, project
...
class ObjectDetectionMasking:
    ...
    def sync_callback(self, img_msg, pc_msg):
        ...
        self.points = pc2_to_numpy(pc_msg)
    ...
    def grounded_segmentation(self, text_label):
        ...
        for box, score, labels in zip(result["boxes"], result["scores"], result["labels"]):
            ...
            if("cup" in labels):
                ...
                points_uv = project(self.points[:,:3], K, dist_coeffs)
                ...
                header = self.header
                object_points = self.points[mask]
